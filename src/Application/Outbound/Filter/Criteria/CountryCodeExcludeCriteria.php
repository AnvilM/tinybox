 ...
 */
final readonly class CountryCodeExcludeCriteria implements OutboundFilterCriteriaExceptOutboundsInterface
{
    /**
     ...
     *                            NOTE: independent from {@see CountryCodeCriteria::$onlyAvailable} -
