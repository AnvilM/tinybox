...
final readonly class ReadOutbounds
{
    ...
    /**
     * Read outbounds list from file
     *
     * @return array Unvalidated JSON decoded array of outbounds
     *
    ...
    public function read(): array
    {
        return $this->readJsonFileNotifyPort
            ->notifyStartAndSuccess(
                "Reading outbounds list file...",
                "Outbounds list file successfully read"
            )->read($this->configInstancePort->get()->outboundsListPath);
    }
}