...
namespace App\Core\Shared\ReporterEvent\Events\GenerateConfigs\Handler\CreateSingBoxConfig;
...
final readonly class UnableToEncodeJSONReporterEvent extends ReporterEvent
{
